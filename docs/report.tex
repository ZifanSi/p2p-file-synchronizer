...
\noindent Entire codes + docs + test/run/debug files structure on GitHub: \url{https://github.com/ZifanSi/p2p-file-synchronizer}

\vspace{0.5em}
\noindent Codes in the \path{src/} directory, docs in the \path{docs/} directory.
