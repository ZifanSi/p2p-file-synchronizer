...
\textbf{Observed:} Peers bound successfully to ports (e.g., 8000, 8001, 8002) without errors.
...
\textbf{Observed:} Tracker logged 3 client connections and peers received directory responses including \texttt{fileA.txt}, \texttt{fileB.txt}, and \texttt{fileC.txt}.
...
\textbf{Observed:} After running, Peer1/Peer2/Peer3 all contained \texttt{fileA.txt}, \texttt{fileB.txt}, \texttt{fileC.txt}.
